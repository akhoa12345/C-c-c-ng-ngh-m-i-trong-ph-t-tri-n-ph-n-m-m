...
def predictionModel(dataSrc, name):
    ...
    train_data=final_dataset[0:275,:]
    valid_data=final_dataset[275:,:]
    ...
    lstm_model.save("LSTM_Model_For_" + name + ".h5")

    train_data=new_dataset[:275]
    valid_data=new_dataset[275:]
