...
train_BTC, valid_BTC = prediction(df_BTC, "./LSTM_Model_For_btc.h5")
train_ETH, valid_ETH = prediction(df_ETH, "./LSTM_Model_For_eth.h5")
train_ADA, valid_ADA = prediction(df_ADA, "./LSTM_Model_For_ada.h5")
